...
(beta)*cos(alpha)*m__l*(cos(beta)^2*gamma__alpha^2+gamma__beta^2)+G00*(m+m__l))
...
^2*cos(alpha)^2*n__1+(cos(alpha)*n3p+gamma__alpha*sin(alpha)*(-G00+n__3))*
gamma__beta)*L*m)/(-G00+n__3)/cos(beta)/cos(alpha);
...
cos(beta)^3*sin(beta)*sin(alpha)*m*n__1-3*cos(alpha)*L*m*((2/3*n3p*gamma__alpha
+1/3*n__2)*cos(alpha)+(gamma__beta^2+2/3*gamma__alpha^2)*sin(alpha)*(-G00+n__3)
)*cos(beta)^2+(-4*L*gamma__beta*gamma__alpha*sin(beta)*m*(-G00+n__3)*cos(alpha)
^2+2*L*gamma__beta*sin(beta)*cos(alpha)*sin(alpha)*m*n3p+2*(-1/2*(m+m__l)*(-G00
+n__3)*sin(alpha)+L*gamma__beta*gamma__alpha*sin(beta)*m)*(-G00+n__3))*cos(beta
...
)*n__2-sin(beta)*n__1)*cos(alpha)^3+3*L*(1/3*gamma__alpha^2*(-G00+n__3)*cos(
beta)^4+((gamma__beta^2+2/3*gamma__alpha^2)*n__3+(-gamma__beta^2-2/3*
gamma__alpha^2)*G00-1/3*n3pp)*cos(beta)^2-2/3*gamma__beta*cos(beta)*sin(beta)*
n3p-2/3*gamma__beta^2*(-G00+n__3))*m*cos(alpha)^2-4*cos(beta)*(1/2*L*
gamma__alpha*cos(beta)*sin(alpha)*m*n3p+(L*gamma__beta*gamma__alpha*sin(beta)*
sin(alpha)*m-1/4*(m+m__l)*(-G00+n__3))*(-G00+n__3))*cos(alpha)-2*L*gamma__alpha
^2*cos(beta)^2*m*(-G00+n__3))/(-G00+n__3)/cos(beta)/cos(alpha);
